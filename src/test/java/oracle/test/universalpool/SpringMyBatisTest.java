...
import oracle.test.universalpool.mybatis.samples.mappers.TransactionDao;
import oracle.test.universalpool.mybatis.samples.model.Transaction;
import oracle.test.universalpool.mybatis.samples.service.TransactionService;
...
//        session.getMapper(Object.class).findAll();
        session.getMapper(TransactionDao.class);
