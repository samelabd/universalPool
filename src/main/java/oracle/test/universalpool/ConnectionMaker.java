...
//				classLoader.
	...
	@GetMapping("/yy")
	public  @ResponseBody void getConnection()
			throws SQLException, UniversalConnectionPoolException {
		 mgr = UniversalConnectionPoolManagerImpl.getUniversalConnectionPoolManager();
		 String dbUrl = "x"; String userName ="ES_RIM"; String password="esdmsearim"; String poolName="poolName";
...
//			}
			...
			Url = "  jdbc:oracle:thin:@(DESCRIPTION =" + 
					"  (LOAD_BALANCE=on)" + 
					"    (ADDRESS = (PROTOCOL = TCP)(HOST = rmodadev-scan)(PORT = 1521))" + 
					"        (CONNECT_DATA =" + 
					"      (SERVER = DEDICATED)" + 
					"      (SERVICE_NAME = odatestdb)" + 
					"    )" + 
					"  ) ";
